...
public class employeeList {
    public static void addEmp(WebDriver driver) {
        try {
            ...
            staff.add(new employee("你再猜", 3, "555666777", "13188990077", "2018-10-29"));
            ...
            for (employee e : staff) {
                ...
                Thread.sleep(500);
                if(driver.findElement(By.className("zeromodal-title1")).getText().equals("员工工号已存在") || driver.findElement(By.className("zeromodal-title1")).getText().equals("已经存在相同的账号")){
    ...
    public static void updataEmp(WebDriver driver){
        try {
            ...
            driver.findElement(By.id("CompanyEmployeesList_updateJoinDate"));
            Thread.sleep(500);
            driver.findElement(By.id("btnupdateUser")).click();
            Thread.sleep(500);
            driver.findElement(By.className("zeromodal-close")).click();
