...
public class editOrder {
    public String orderId = "20190328026";
     ...
     */
    @Test
    public String entryOrder(String customNo, WebDriver driver) {
        try {
     ...
     */
    @Test
    public String handleOrder(WebDriver driver) {
        try {
            //查询订单 处理订单
     ...
     */
    @Test
    public String activateOrder(WebDriver driver) {
        try {
            //查询订单
            driver.switchTo().frame("mainframe");
            driver.findElement(By.id("orderNo$text")).sendKeys(orderId);
            driver.findElement(By.xpath("//*[@id=\"queryForm\"]/table/tbody/tr[3]/td[5]/a/span"));
            //订单激活
            Thread.sleep(1000);
            driver.findElement(By.className("mini-grid-radio-mask")).click();
            driver.findElement(By.cssSelector(".mini-button-text.mini-button-icon.icon-edit")).click();
